        ...
        <tbody>
            @foreach ($specials as $special)
                <tr class="text-start align-middle">
                    <td class="col">{{ $special->id }}</td>
                    <td class="col">{{ $special->category_name }}</td>
                    <td class="col">{{ $special->service_name }}</td>
                    <td class="col">{{ $special->service_desc }}</td>
                    <td class="col">{{ $special->office_unit }}</td>
                    <td class="col">{{ $special->created_at }}</td>

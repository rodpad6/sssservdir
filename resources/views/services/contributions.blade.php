        ...
        <tbody>
            @foreach ($contributions as $contribution)
                <tr class="text-start align-middle">
                    <td class="col">{{ $contribution->id }}</td>
                    <td class="col">{{ $contribution->category_name }}</td>
                    <td class="col">{{ $contribution->service_name }}</td>
                    <td class="col">{{ $contribution->service_desc }}</td>
                    <td class="col">{{ $contribution->office_unit }}</td>
                    <td class="col">{{ $contribution->created_at }}</td>

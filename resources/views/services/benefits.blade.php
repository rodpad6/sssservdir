        ...
        <tbody>
            @foreach ($benefits as $benefit)
                <tr class="text-start align-middle">
                    <td class="col">{{ $benefit->id }}</td>
                    <td class="col">{{ $benefit->category_name }}</td>
                    <td class="col">{{ $benefit->service_name }}</td>
                    <td class="col">{{ $benefit->service_desc }}</td>
                    <td class="col">{{ $benefit->office_unit }}</td>
                    <td class="col">{{ $benefit->created_at }}</td>
